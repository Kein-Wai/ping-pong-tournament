...
exports.calculateMatchResults = exports.isValidTableTennisSet = void 0;
const isValidTableTennisSet = (score1, score2) => {
...
exports.isValidTableTennisSet = isValidTableTennisSet;
const calculateMatchResults = (match) => {
    const sets = [
